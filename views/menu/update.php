...
/* ===========================以下为本页配置信息================================= */
/* 页面基本属性 */
$this->title = Yii::t('app', ($this->context->action->id == 'create' ? '添加' : '更新') . '菜单');
...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        ...
        <?=$form->field($model, 'pid')->selectList(
            ArrayHelper::merge(['0'=>'一级栏目'],ArrayHelper::listDataLevel( app\models\Menu::find()->asArray()->all(), 'id', 'title','id','pid')),
