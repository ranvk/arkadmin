...
$this->title = 'Uker\'s 后台管理';

?>

    <ol class="breadcrumb">
        <li class="active"><i class="fa fa-home fa-fw"></i> 主页</li>
    </ol>
            ...
            <div class="col-md-6">
                ...
                <div class="panel ">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6 text-center pie-box">
                            <div class="pie-chart" data-percent="34" data-bar-color="#1F8A70"><span>0%</span>
                            </div>
                            <a href="#" class="pie-title">Tweets</a>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-6 text-center pie-box">
                            <div class="pie-chart" data-percent="57" data-bar-color="#FF530D"><span>0%</span>
                            </div>
